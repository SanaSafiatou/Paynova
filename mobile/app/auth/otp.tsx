      ...
      >
        <View style={styles.container}>
          ...
          <View style={styles.logoContainer}>
            ...
            <Text style={styles.logoSubtitle}>Vérification du code</Text>
          </View>

          {/* Carte formulaire */}
          <View style={styles.card}>
            <Text style={styles.cardTitle}>Code de validation</Text>
            ...
            <Text style={styles.hint}>
              Entrez le code à 4 chiffres reçu de l{'\''}administrateur
            </Text>
