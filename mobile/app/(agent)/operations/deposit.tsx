...
import { identifyClient, agentDeposit } from '../../../src/api/client';
  ...
  if (step === 'done') {
    return (
      <View style={styles.doneContainer}>
        ...
        <Text style={styles.doneTitle}>Dépôt effectué</Text>
        <Text style={styles.doneAmount}>{parseFloat(amount.replace(/,/g, '')).toLocaleString('fr-FR')} F CFA</Text>
        <Text style={styles.doneSubtitle}>Dépôt sur le compte de {client?.name || client?.phone}</Text>
        <TouchableOpacity
        ...
        >
          <Text style={styles.doneBtnText}>Nouveau dépôt</Text>
        </TouchableOpacity>
    ...
    return (
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
        <ScrollView style={styles.container} contentContainerStyle={styles.content}>
          ...
          <Text style={styles.title}>Confirmer le dépôt</Text>
          ...
          >
            {loading ? (
              ...
              <Text style={styles.primaryBtnText}>Confirmer le dépôt</Text>
            )}
          </TouchableOpacity>
        </ScrollView>
